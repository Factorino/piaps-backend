...
_to_domain: Callable[[PayrollItemORM], PayrollItem] = get_mapper(
    PayrollItemORM,
    PayrollItem,
    recipe=[
        link(P[PayrollItemORM].code, P[PayrollItem].code, coercer=Code.from_str),
        link(P[PayrollItemORM].name, P[PayrollItem].name, coercer=lambda n: Name(value=n)),
    ],
)
