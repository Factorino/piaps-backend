...
@dto
class CancelPayrollSheetRequest:
    id: PayrollSheetId
...
class CancelPayrollSheet(Interactor[CancelPayrollSheetRequest, CancelPayrollSheetResponse]):
    ...
    async def execute(self, request: CancelPayrollSheetRequest) -> CancelPayrollSheetResponse:
    ...
    def _check_access(self, current_user: User) -> None:
        if current_user.role < UserRole.ACCOUNTANT:
            raise AccessDeniedError("You don't have permission to cancel payroll sheets")
